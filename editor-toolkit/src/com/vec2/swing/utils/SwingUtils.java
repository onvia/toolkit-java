...
public class SwingUtils {
	...
	public static void warning(Component component,String title,String content) {
		 // 消息对话框无返回, 仅做通知作用
	...
	public static final void addPopup(Component component, final JPopupMenu popup) {
		component.addMouseListener(new SwingUtils.MouseRightButtonListener() {
			@Override
	...
	public static final void addPopup(JPopupMenu popupMenu, String label, ActionListener actionListener) {
		JMenuItem menuItem = new JMenuItem(Language.get(label));
	...
	public static class DropInAdapter extends DropTargetAdapter {
